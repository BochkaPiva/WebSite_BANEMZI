  ...
  const contacts = [
    {
      ...
      label: 'Email',
      value: 'info@web-site-banemzi.vercel.app',
      href: 'mailto:info@web-site-banemzi.vercel.app',
    ...
    >
      <div className="bg-[#111] rounded-2xl p-6 max-w-5xl max-h-[90vh] overflow-y-auto border border-white/10 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        ...
        <div className="text-white/80 space-y-4 text-sm leading-relaxed modal-content">
          ...
          <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок сбора и обработки персональных данных пользователей веб-сайта web-site-banemzi.vercel.app и меры по обеспечению безопасности персональных данных, предпринимаемые BANEMZI (далее — Оператор).</p>
          
          <p>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
          
          <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о пользователях веб-сайта web-site-banemzi.vercel.app</p>
          ...
          <p>2.6. <strong>Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта web-site-banemzi.vercel.app</p>
          <p>2.7. <strong>Пользователь, субъект персональных данных</strong> — любой посетитель веб-сайта web-site-banemzi.vercel.app</p>
          ...
          <p>8.5. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора info@web-site-banemzi.vercel.app с пометкой «Отзыв согласия на обработку персональных данных».</p>
          ...
          <p>11.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты info@web-site-banemzi.vercel.app</p>
    ...
    >
      <div className="bg-[#111] rounded-2xl p-6 max-w-5xl max-h-[90vh] overflow-y-auto border border-white/10 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        ...
        <div className="text-white/80 space-y-4 text-sm leading-relaxed modal-content">
          ...
          <p>Согласие может быть отозвано мною в любое время на основании моего письменного заявления, направленного на электронный адрес info@web-site-banemzi.vercel.app с пометкой «Отзыв согласия на обработку персональных данных».</p>
    ...
    >
      <div className="bg-[#111] rounded-2xl p-6 max-w-5xl max-h-[90vh] overflow-y-auto border border-white/10 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        ...
        <div className="text-white/80 space-y-4 text-sm leading-relaxed modal-content">
          ...
          <p>По вопросам, связанным с использованием cookie, обращайтесь: info@web-site-banemzi.vercel.app</p>
        </div>
      </div>
    </div>
  );
    ...
    >
      <div className="bg-[#111] rounded-2xl p-6 max-w-5xl max-h-[90vh] overflow-y-auto border border-white/10 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        ...
        <div className="text-white/80 space-y-4 text-sm leading-relaxed modal-content">
          ...
          <p>Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует отношения между пользователями сайта web-site-banemzi.vercel.app (далее — «Сайт») и компанией BANEMZI (далее — «Компания», «мы»).</p>
          ...
          Email: info@web-site-banemzi.vercel.app<br />
          Telegram: @banemzi<br />
          Сайт: web-site-banemzi.vercel.app<br />
          ...
          <p><strong>Email:</strong> info@web-site-banemzi.vercel.app<br />
