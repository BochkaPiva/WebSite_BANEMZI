    ...
    <Reveal className="relative w-full">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-white/60 text-lg max-w-2xl mx-auto">
          ...
          Основной офис в Омске, но организуем мероприятия по всей стране.
        </p>
        <div className="sr-only">
          <h3>Ивент агентство BANEMZI работает в городах:</h3>
          <p>Омск, Новосибирск, Тюмень, Барнаул, Кемерово, Красноярск, Екатеринбург, Челябинск, Уфа, Москва, Санкт-Петербург и других городах России. Основной офис расположен в Омске.</p>
        </div>
      </div>
